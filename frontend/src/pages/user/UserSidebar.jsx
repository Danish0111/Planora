    ...
    <>
      <div className="p-4">
        <div className="flex flex-col items-center justify-center pt-16 md:p-4">
          ...
          <div className="bg-blue-600 rounded px-2 py-1 text-xs text-white mt-2">
            {authUser?.role}
          </div>

          <div className="font-bold mt-2 text-center text-sm md:text-base">
            {authUser?.fullName}
          </div>

          <div className="text-xs md:text-sm text-gray-500 text-center break-all px-2">
            {authUser?.email}
          </div>
        </div>
      </div>
