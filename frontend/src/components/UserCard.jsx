    ...
    return (
        <div className="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-6">
                {
                    userInfo.profileImageUrl !== null ? (
                        ...
                        <User className="size-10 rounded-full bg-gray-300 p-2" />
                    )
                }
                <div>
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className={`p-2 rounded-lg ${getStatusBadgeColor('Pending')}`}>
                ...
                <div className={`p-2 rounded-lg ${getStatusBadgeColor('In Progress')}`}>
                    <div className='font-bold'>
                ...
                <div className={`p-2 rounded-lg ${getStatusBadgeColor('Completed')}`}>
                    <div className='font-bold'>
